...
import { idlFactory } from './trade_executor.did.js';
export { idlFactory } from './trade_executor.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_TRADE_EXECUTOR;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./trade_executor.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the trade_executor canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./trade_executor.did.js")._SERVICE>}
 */
export const trade_executor = createActor(canisterId);
