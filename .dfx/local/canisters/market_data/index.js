...
import { idlFactory } from './market_data.did.js';
export { idlFactory } from './market_data.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_MARKET_DATA;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./market_data.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the market_data canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./market_data.did.js")._SERVICE>}
 */
export const market_data = createActor(canisterId);
