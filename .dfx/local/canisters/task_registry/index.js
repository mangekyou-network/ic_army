...
import { idlFactory } from './task_registry.did.js';
export { idlFactory } from './task_registry.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_TASK_REGISTRY;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./task_registry.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the task_registry canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./task_registry.did.js")._SERVICE>}
 */
export const task_registry = createActor(canisterId);
