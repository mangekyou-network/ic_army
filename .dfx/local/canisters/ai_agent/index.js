...
import { idlFactory } from './ai_agent.did.js';
export { idlFactory } from './ai_agent.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_AI_AGENT;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./ai_agent.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the ai_agent canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./ai_agent.did.js")._SERVICE>}
 */
export const ai_agent = createActor(canisterId);
