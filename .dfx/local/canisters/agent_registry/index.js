...
export const canisterId = process.env.CANISTER_ID_AGENT_REGISTRY;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./agent_registry.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the agent_registry canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./agent_registry.did.js")._SERVICE>}
 */
export const agent_registry = createActor(canisterId);
