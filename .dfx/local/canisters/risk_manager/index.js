...
import { idlFactory } from './risk_manager.did.js';
export { idlFactory } from './risk_manager.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_RISK_MANAGER;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./risk_manager.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the risk_manager canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./risk_manager.did.js")._SERVICE>}
 */
export const risk_manager = createActor(canisterId);
