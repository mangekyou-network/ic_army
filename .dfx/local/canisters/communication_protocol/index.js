...
import { idlFactory } from './communication_protocol.did.js';
export { idlFactory } from './communication_protocol.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_COMMUNICATION_PROTOCOL;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./communication_protocol.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the communication_protocol canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./communication_protocol.did.js")._SERVICE>}
 */
export const communication_protocol = createActor(canisterId);
