...
import { idlFactory } from './market_sentiment.did.js';
export { idlFactory } from './market_sentiment.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_MARKET_SENTIMENT;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./market_sentiment.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the market_sentiment canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./market_sentiment.did.js")._SERVICE>}
 */
export const market_sentiment = createActor(canisterId);
