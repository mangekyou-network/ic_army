...
import { idlFactory } from './trading_bot.did.js';
export { idlFactory } from './trading_bot.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_TRADING_BOT;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./trading_bot.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the trading_bot canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./trading_bot.did.js")._SERVICE>}
 */
export const trading_bot = createActor(canisterId);
