...
import { idlFactory } from './technical_analyst.did.js';
export { idlFactory } from './technical_analyst.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_TECHNICAL_ANALYST;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./technical_analyst.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the technical_analyst canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./technical_analyst.did.js")._SERVICE>}
 */
export const technical_analyst = createActor(canisterId);
